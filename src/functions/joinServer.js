...
export default function joinServer(retryFunction) {
  Swal.fire({
    ...
    html: `Join our Discord server to create and edit projects and stay updated on DisFuse. Click the link below to join.<br /><br /><a href="https://dsc.gg/disfuse" target="_blank" rel="noopener noreferrer">Join Discord</a>`,
