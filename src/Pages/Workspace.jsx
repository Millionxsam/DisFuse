            ...
            .then(async ({ data: user }) => {
              ...
              socket.emit(
                ...
                async (project, activeUsers) => {
                  ...
                  if (
                    localStorage.getItem("componentsV2Onboarding") !== "true"
                  ) {
                    const componentsV2Onboarding = Swal.mixin({
                      progressSteps: ["1", "2", "3", "4"],
                      animation: false,
                      icon: "info",
                      allowEscapeKey: false,
                    ...
                    while (currentStep >= 0 && currentStep < slides.length) {
                      const result = await componentsV2Onboarding.fire({
                        currentProgressStep: currentStep,
                        ...slides[currentStep],
                        animation: !startedOnboarding,
                      });
                  ...
                  document
                    ...
                    .addEventListener("click", async () => {
                      ...
                      Swal.fire({
                        ...
                        zip.file("index.js", `${await format(indexjs)}`);
