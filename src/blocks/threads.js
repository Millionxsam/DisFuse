...
Blockly.Blocks['threads_msgCreateThread'] = {
    init: function () {
        ...
        this.appendValueInput('slowmode')
            .setCheck('Number').appendField('slowmode (seconds):');
        this.appendDummyInput()
            .appendField('type:')
...
Blockly.Blocks['threads_createdAt'] = {
    init: function () {
        this.appendValueInput('thread')
            .setCheck('thread').appendField('creation date of thread:');
        this.setOutput(true, 'date');
        this.setColour('#5b67a5');
    }
};

javascriptGenerator.forBlock['threads_createdAt'] = function (block, generator) {
...
Blockly.Blocks['threads_lastMessage'] = {
    init: function () {
        this.appendValueInput('thread')
            .setCheck('thread').appendField('last message of thread:');
        this.setOutput(true, 'message');
        this.setColour('#5b67a5');
    }
};

javascriptGenerator.forBlock['threads_lastMessage'] = function (block, generator) {
    var thread = generator.valueToCode(block, 'thread', Order.ATOMIC);
...
Blockly.Blocks['threads_setLocked'] = {
    init: function () {
        this.appendValueInput('thread')
            .setCheck('thread').appendField('Set locked status of thread:');
        this.appendValueInput('locked')
            .setCheck('Boolean').appendField('to:');
        this.setPreviousStatement('default', null);
        this.setNextStatement('default', null);
        this.setColour('#5b67a5');
    }
...
javascriptGenerator.forBlock['threads_setLocked'] = function (block, generator) {
    var thread = generator.valueToCode(block, 'thread', Order.ATOMIC);
...
Blockly.Blocks['threads_setName'] = {
    init: function () {
        this.appendValueInput('thread')
            .setCheck('thread').appendField('Rename thread:');
        this.appendValueInput('name')
            .setCheck('String').appendField('to:');
        this.setPreviousStatement('default', null);
        this.setNextStatement('default', null);
        this.setColour('#5b67a5');
    }
...
Blockly.Blocks['threads_setArchived'] = {
    init: function () {
        this.appendValueInput('thread')
            .setCheck('thread').appendField('Set archived status of thread:');
        this.appendValueInput('archived')
            .setCheck('Boolean').appendField('to:');
        this.setPreviousStatement('default', null);
        this.setNextStatement('default', null);
        this.setColour('#5b67a5');
...
javascriptGenerator.forBlock['threads_setArchived'] = function (block, generator) {
    var thread = generator.valueToCode(block, 'thread', Order.ATOMIC);
...
Blockly.Blocks['threads_pin'] = {
    init: function () {
        this.appendValueInput('thread')
            .setCheck('thread').appendField('Pin thread:');
        this.setPreviousStatement('default', null);
        this.setNextStatement('default', null);
        this.setColour('#5b67a5');
    }
...
Blockly.Blocks['threads_unpin'] = {
    init: function () {
        this.appendValueInput('thread')
            .setCheck('thread').appendField('Unpin thread:');
        this.setPreviousStatement('default', null);
        this.setNextStatement('default', null);
        this.setColour('#5b67a5');
    }
...
Blockly.Blocks['threads_join'] = {
    init: function () {
        this.appendValueInput('thread')
            .setCheck('thread').appendField('Join thread:');
        this.setPreviousStatement('default', null);
        this.setNextStatement('default', null);
        this.setColour('#5b67a5');
    }
...
Blockly.Blocks['threads_leave'] = {
    init: function () {
        this.appendValueInput('thread')
            .setCheck('thread').appendField('Leave thread:');
        this.setPreviousStatement('default', null);
        this.setNextStatement('default', null);
        this.setColour('#5b67a5');
    }
...
Blockly.Blocks['threads_setSlowmode'] = {
    init: function () {
        this.appendValueInput('thread')
            .setCheck('thread').appendField('set slowmode of:');
        this.appendValueInput('slowmode')
            .setCheck('Number').appendField('slowmode (seconds):');
        this.setPreviousStatement('default', null);
        this.setNextStatement('default', null);
...
javascriptGenerator.forBlock['threads_setSlowmode'] = function (block, generator) {
    var thread = generator.valueToCode(block, 'thread', Order.ATOMIC);
...
Blockly.Blocks['threads_author'] = {
    init: function () {
        this.appendValueInput('thread')
            .setCheck('thread').appendField('author of thread:');
...
Blockly.Blocks['threads_authorMember'] = {
    init: function () {
        this.appendValueInput('thread')
            .setCheck('thread').appendField('author member of thread:');
        this.setOutput(true, 'member');
        this.setColour('#5b67a5');
    }
};

javascriptGenerator.forBlock['threads_authorMember'] = function (block, generator) {
    var thread = generator.valueToCode(block, 'thread', Order.ATOMIC);
...
Blockly.Blocks['threads_id'] = {
    init: function () {
        this.appendValueInput('thread')
            .setCheck('thread').appendField('ID of thread:');
        this.setOutput(true, 'String');
        this.setColour('#5b67a5');
    }
};
...
Blockly.Blocks['threads_memberCount'] = {
    init: function () {
        this.appendValueInput('thread')
            .setCheck('thread').appendField('number of members in thread:');
        this.setOutput(true, 'Number');
        this.setColour('#5b67a5');
    }
};

javascriptGenerator.forBlock['threads_memberCount'] = function (block, generator) {
    var thread = generator.valueToCode(block, 'thread', Order.ATOMIC);
...
Blockly.Blocks['threads_parentChannel'] = {
    init: function () {
        this.appendValueInput('thread')
            .setCheck('thread').appendField('parent channel of thread:');
        this.setOutput(true, 'channel');
        this.setColour('#5b67a5');
    }
};

javascriptGenerator.forBlock['threads_parentChannel'] = function (block, generator) {
    var thread = generator.valueToCode(block, 'thread', Order.ATOMIC);
...
javascriptGenerator.forBlock["threads_msgThread"] = function (block, generator) {
...
javascriptGenerator.forBlock["threads_msgHasThread"] = function (block, generator) {
    var value_message = generator.valueToCode(block, "message", Order.ATOMIC);
...
javascriptGenerator.forBlock['threads_removeUser'] = function (block, generator) {
    var val_user = generator.valueToCode(block, 'user', Order.ATOMIC);
    var val_thread = generator.valueToCode(block, 'thread', Order.ATOMIC);
