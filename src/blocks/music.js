...
Blockly.Blocks['music_findLyrics'] = {
    init: function () {
        this.appendDummyInput()
            .appendField('Get lyrics');
        this.appendValueInput('artist')
            .setCheck('String').appendField('by artist:');
        this.appendValueInput('song')
            .setCheck('String').appendField('song name:');
        this.appendStatementInput('then')
            .setCheck(null).appendField('then:');
...
javascriptGenerator.forBlock['music_findLyrics_lyrics'] = () => ['lyrics || "No Lyrics Found!"', Order.NONE];
