...
javascriptGenerator.forBlock["member_status"] = function (
  block,
  generator
) {
...
javascriptGenerator.forBlock["member_userFlags"] = function (
  block,
  generator
) {
...
javascriptGenerator.forBlock["member_created"] = function (
  block,
  generator
) {
  var member = generator.valueToCode(block, "member", Order.ATOMIC);
...
javascriptGenerator.forBlock["member_accent"] = function (
  block,
  generator
) {
  var member = generator.valueToCode(block, "member", Order.ATOMIC);
...
javascriptGenerator.forBlock["member_system"] = function (
  block,
  generator
) {
  var member = generator.valueToCode(block, "member", Order.ATOMIC);
...
javascriptGenerator.forBlock["member_bot"] = function (
  block,
  generator
) {
  var member = generator.valueToCode(block, "member", Order.ATOMIC);
...
javascriptGenerator.forBlock["member_username"] = function (
  block,
  generator
) {
  var member = generator.valueToCode(block, "member", Order.ATOMIC);
...
javascriptGenerator.forBlock["member_user"] = function (
  block,
  generator
) {
  var member = generator.valueToCode(block, "member", Order.ATOMIC);
...
javascriptGenerator.forBlock["member_nickname"] = function (
  block,
  generator
) {
  var member = generator.valueToCode(block, "member", Order.ATOMIC);
...
javascriptGenerator.forBlock["member_joined"] = function (
  block,
  generator
) {
  var member = generator.valueToCode(block, "member", Order.ATOMIC);
...
javascriptGenerator.forBlock["member_id"] = function (
  block,
  generator
) {
  var member = generator.valueToCode(block, "member", Order.ATOMIC);
...
javascriptGenerator.forBlock["member_color"] = function (
  block,
  generator
) {
  var member = generator.valueToCode(block, "member", Order.ATOMIC);
...
javascriptGenerator.forBlock["member_timedout"] = function (
  block,
  generator
) {
  var member = generator.valueToCode(block, "member", Order.ATOMIC);
...
javascriptGenerator.forBlock["member_kickable"] = function (
  block,
  generator
) {
  var member = generator.valueToCode(block, "member", Order.ATOMIC);
...
javascriptGenerator.forBlock["member_bannable"] = function (
  block,
  generator
) {
  var member = generator.valueToCode(block, "member", Order.ATOMIC);
...
javascriptGenerator.forBlock["member_setnick"] = function (
  block,
  generator
) {
  var member = generator.valueToCode(block, "member", Order.ATOMIC);
...
javascriptGenerator.forBlock["member_dm"] = function (
  block,
  generator
) {
  var user = generator.valueToCode(block, "member", Order.ATOMIC);
...
javascriptGenerator.forBlock["member_kick"] = function (
  block,
  generator
) {
  var member = generator.valueToCode(block, "member", Order.ATOMIC);
...
javascriptGenerator.forBlock["member_timeout"] = function (
  block,
  generator
) {
  var member = generator.valueToCode(block, "member", Order.ATOMIC);
...
javascriptGenerator.forBlock["member_ban"] = function (
  block,
  generator
) {
  var member = generator.valueToCode(block, "member", Order.ATOMIC);
...
javascriptGenerator.forBlock["member_member"] = function (
  block,
  generator
) {
  var code = `member`;
...
javascriptGenerator.forBlock["member_foreach"] = function (
  block,
  generator
) {
...
javascriptGenerator.forBlock["member_getuser"] = function (
  block,
  generator
) {
...
javascriptGenerator.forBlock["member_getone"] = function (
  block,
  generator
) {
  var dropdown_type = block.getFieldValue("type");
