...
Blockly.Blocks['roles_name'] = {
  init: function () {
    this.appendValueInput('role')
      .setCheck('role').appendField('name of role:');
    this.setColour('#32a87d');
    this.setTooltip('');
    this.setHelpUrl('');
...
Blockly.Blocks['roles_position'] = {
  init: function () {
    this.appendValueInput('role')
      .setCheck('role').appendField('position of role:');
    this.setColour('#32a87d');
    this.setTooltip('');
    this.setHelpUrl('');
...
Blockly.Blocks['roles_hexColor'] = {
  init: function () {
    this.appendValueInput('role')
      .setCheck('role').appendField('hex color of role:');
    this.setColour('#32a87d');
    this.setTooltip('');
    this.setHelpUrl('');
    this.setOutput(true, 'String');
...
Blockly.Blocks['roles_id'] = {
  init: function () {
    this.appendValueInput('role')
      .setCheck('role').appendField('ID of role:');
    this.setColour('#32a87d');
    this.setOutput(true, 'String');
  }
};
...
Blockly.Blocks['roles_createdAt'] = {
  init: function () {
    this.appendValueInput('role')
      .setCheck('role').appendField('creation date of role:');
    this.setColour('#32a87d');
    this.setTooltip('');
    this.setHelpUrl('');
...
Blockly.Blocks['roles_create'] = {
  init: function () {
    this.appendValueInput('name')
      .setCheck('String').appendField('Create new role named:');
    this.appendValueInput('server')
      .setCheck('server').appendField('in server:');
    this.appendValueInput('color')
      .setCheck('Colour').appendField('color:');
    this.appendValueInput('position')
      .setCheck('Number').appendField('position:');
    this.appendValueInput('mentionable')
      .setCheck('Boolean').appendField('can be mentioned?');
    this.appendValueInput('permissions')
      .setCheck(['Array', 'permission']).appendField('permissions:');
    this.setColour('#32a87d');
...
Blockly.Blocks['roles_delete'] = {
  init: function () {
    this.appendValueInput('role')
      .setCheck('role').appendField('Delete the role:');
    this.appendValueInput('reason')
      .setCheck('String').appendField('reason:');
    this.setColour('#32a87d');
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
  }
...
Blockly.Blocks['roles_rename'] = {
  init: function () {
    this.appendValueInput('role')
      .setCheck('role').appendField('Rename role:');
    this.appendValueInput('name')
      .setCheck('String').appendField('new name:');
    this.setColour('#32a87d');
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
  }
...
Blockly.Blocks['roles_addToMember'] = {
  init: function () {
    this.appendValueInput('role')
      .setCheck(['role', 'Array']).appendField('Add role:');
    this.appendValueInput('member')
      .setCheck('member').appendField('to member:');
    this.setColour('#32a87d');
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
  }
...
Blockly.Blocks['roles_removeFromMember'] = {
  init: function () {
    this.appendValueInput('role')
      .setCheck(['role', 'Array']).appendField('Remove role:');
    this.appendValueInput('member')
      .setCheck('member').appendField('from member:');
    this.setColour('#32a87d');
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
  }
...
Blockly.Blocks['roles_setPermissions'] = {
  init: function () {
    this.appendValueInput('permissions')
      .setCheck(['permission', 'Array']).appendField('Set permissions:');
    this.appendValueInput('role')
      .setCheck('role').appendField('to role:');
    this.setColour('#32a87d');
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
  }
