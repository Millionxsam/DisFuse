...
Blockly.Blocks["game_2048"] = {
  init: function () {
    this.appendDummyInput()
      .appendField("Start game 2048 with")
      .appendField(
...
Blockly.Blocks["game_connect4"] = {
  init: function () {
    this.appendDummyInput()
      .appendField("Start game Connect4 with")
      .appendField(
        new Blockly.FieldDropdown([
          ["text command", "false"],
          ["slash command", "true"],
...
Blockly.Blocks["game_fasttype"] = {
  init: function () {
    this.appendDummyInput()
      .appendField("Start game FastType with")
      .appendField(
        new Blockly.FieldDropdown([
          ["text command", "false"],
          ["slash command", "true"],
...
Blockly.Blocks["game_findemoji"] = {
  init: function () {
    this.appendDummyInput()
      .appendField("Start game FindEmoji with")
      .appendField(
        new Blockly.FieldDropdown([
          ["text command", "false"],
          ["slash command", "true"],
...
Blockly.Blocks["game_flood"] = {
  init: function () {
    this.appendDummyInput()
      .appendField("Start game Flood with")
      .appendField(
        new Blockly.FieldDropdown([
          ["text command", "false"],
          ["slash command", "true"],
...
Blockly.Blocks["game_hangman"] = {
  init: function () {
    this.appendDummyInput()
      .appendField("Start game Hangman with")
      .appendField(
        new Blockly.FieldDropdown([
          ["text command", "false"],
          ["slash command", "true"],
...
Blockly.Blocks["game_matchpairs"] = {
  init: function () {
    this.appendDummyInput()
      .appendField("Start game MatchPairs with")
      .appendField(
        new Blockly.FieldDropdown([
          ["text command", "false"],
          ["slash command", "true"],
...
Blockly.Blocks["game_minesweeper"] = {
  init: function () {
    this.appendDummyInput()
      .appendField("Start game Minesweeper with")
      .appendField(
        new Blockly.FieldDropdown([
          ["text command", "false"],
          ["slash command", "true"],
...
Blockly.Blocks["game_rps"] = {
  init: function () {
    this.appendDummyInput()
      .appendField("Start game RockPaperScissors with")
      .appendField(
        new Blockly.FieldDropdown([
          ["text command", "false"],
          ["slash command", "true"],
...
Blockly.Blocks["game_slots"] = {
  init: function () {
    this.appendDummyInput()
      .appendField("Start game Slots with")
      .appendField(
        new Blockly.FieldDropdown([
          ["text command", "false"],
          ["slash command", "true"],
...
Blockly.Blocks["game_snake"] = {
  init: function () {
    this.appendDummyInput()
      .appendField("Start game Snake with")
      .appendField(
        new Blockly.FieldDropdown([
          ["text command", "false"],
          ["slash command", "true"],
...
Blockly.Blocks["game_tictactoe"] = {
  init: function () {
    this.appendDummyInput()
      .appendField("Start game TicTacToe with")
      .appendField(
        new Blockly.FieldDropdown([
          ["text command", "false"],
          ["slash command", "true"],
...
Blockly.Blocks["game_wordle"] = {
  init: function () {
    this.appendDummyInput()
      .appendField("Start game Wordle with")
      .appendField(
        new Blockly.FieldDropdown([
          ["text command", "false"],
          ["slash command", "true"],
...
Blockly.Blocks["game_trivia"] = {
  init: function () {
    this.appendDummyInput()
      .appendField("Start game Trivia with")
      .appendField(
        new Blockly.FieldDropdown([
          ["text command", "false"],
          ["slash command", "true"],
